...
import com.ott.service.MovieService;
...
public class HomeController {
    ...
    @Autowired
    public HomeController(UserService userService, MovieService productService){
        this.userService=userService;
        this.movieservice=productService;
...
*/
    ...
    public String saveUser(@ModelAttribute("user") User user){
        ...
        return "redirect:/ott/signin-form";
    }
   @PostMapping("/user")
   ...
   /* @GetMapping("/product-form")
    ...
    /*
    @PostMapping("/user/{Id}")
    public String addProduct(@PathVariable("Id") int id, @ModelAttribute("product") Movie product, Model model){
...
*//*
    ...
    public String saveEmployee(@ModelAttribute("movie") Movie employee) {
    ...
    public String showFormForUpdate(@PathVariable ( value = "id") int id, Model model) {
        ...
        Movie employee = movieservice.findProductsByProductsId(id);

        // set employee as a model attribute to pre-populate the form
        model.addAttribute("movie", employee);
    ...
    public String findPaginated(@PathVariable (value = "pageNo") int pageNo,
        ...
        List<Movie> listEmployees = page.getContent();
